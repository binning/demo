        ...
        <div class="container">
            <div class="handle-box">
                <el-select v-model="select_cate" placeholder="全部" class="handle-select mr10">
                    ...
                    <el-option key="2" label="放款中" value="放款中"></el-option>
                    <el-option key="3" label="今日需还" value="今日需还"></el-option>
                    <el-option key="4" label="逾期订单" value="逾期订单"></el-option>
                    <el-option key="5" label="未通过订单" value="未通过订单"></el-option>
                    <el-option key="6" label="已还订单" value="已还订单"></el-option>
                    <el-option key="7" label="待审核" value="待审核"></el-option>
                </el-select>
