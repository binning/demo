        ...
        <div class="container">          
          <div class="handle-box">
                ...
                <el-select v-model="select_cate" placeholder="全部" class="handle-select mr10">
                    ...
                    <el-option key="3" label="信审一组" value="信审一组"></el-option>
                     <el-option key="4" label="催收一组" value="催收一组"></el-option>
                    <el-option key="5" label="客服一组" value="客服一组"></el-option>
                </el-select>
            </div>
            ...
            <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="操作" width="90">
                    <template slot-scope="scope">
                        ...
                        <el-button size="small" type="primary" @click="handleCheck(scope.$index, scope.row)">操作</el-button>
                    </template>
                </el-table-column>
            </el-table>
